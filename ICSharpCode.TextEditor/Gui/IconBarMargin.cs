...
namespace ICSharpCode.TextEditor
{
	...
	public class IconBarMargin : AbstractMargin
	{
		...
		public void DrawBookmark(Graphics g, int y, bool isEnabled)
		{
            ...
            if (isEnabled)
            {
                                                             ...
                                                             Color.White))
                {
                    ...
                    g.FillEllipse(new LinearGradientBrush(new Point(rect.Left, rect.Top), new Point(rect.Right, rect.Bottom), Color.DarkRed, Color.Red), rect);
                }
            }
            else
            {
        ...
        // todo
        void FillCircle(Graphics g, Brush b, Rectangle r)
        {
            using (GraphicsPath gp = CreateCircleGraphicsPath(r))
            {
                g.FillPath(b, gp);
            }
        }
        // todo
        GraphicsPath CreateCircleGraphicsPath(Rectangle r)
        {
